...
// Interface representing the shape returned by your API endpoint
interface Product {
  _id?: string;
  name?: string;
  description?: string;
...
// Interface representing the local state shape for the form
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updateProduct(id as string, {
        ...
        images: [formData.imageInput], // Pass image in expected payload key
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-xs text-slate-400 mt-0.5 font-medium">
            Modify properties, images, and pricing details.
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col sm:flex-row gap-6 pt-4 border-t border-slate-100">
          <label className="flex items-center gap-3 cursor-pointer">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-slate-400">
                Promote it on home pages or featured slots
              </span>
            </div>
          </label>
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-slate-400">
                Let it be visible immediately to shoppers
              </span>
            </div>
          </label>
        </div>
